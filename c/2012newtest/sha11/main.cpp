...
#define M(i) ( tm =   x[i&0x0f] ^ x[(i-14)&0x0f]    \
               ...
               , (x[i&0x0f] = rol(tm,1)) )
//m16=tm=x[16&15=0]^x[2]^x[8]^x[13]
//m17=tm=x[17&15=1]^x[3]^x[9]^x[14]
//m18=tm=x[18&15=2]^x[4]^x[10]^x[15]file<<(f( b, c, d ))	;	
//m19=tm=x[19&15=3]^x[5]^x[11]^x[16]
/*
file<<a;								\
		file<<"\t";								\
		file<<b;								\
